...
```{r final_train}
tm_train=NA
# tm_train <- system.time(fit_train <- train_xgboost(feat_train, label_train, par_best))
load("../output/feature_train.RData")
tm_train <- system.time(fit_train_xgboost <- train_xgboost(feat_train, label_train))
...
```{r superresolution}
source("../lib/superResolution_xgboost.R")
source("../lib/superResolutiontry.R")
source("../lib/test_xgboost.R")
