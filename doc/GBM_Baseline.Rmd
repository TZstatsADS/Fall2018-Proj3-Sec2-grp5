...
```{r loadlib}
source("../lib/GBM_Baseline/train.R")
...
source("../lib/GBM_Baseline/cross_validation.R")
...
if(run.cv){
  ...
  save(err_cv, file="../output/GBM_Baseline/err_cv.RData")
}
```
...
```{r cv_vis}
if(run.cv){
  load("../output/GBM_Baseline/err_cv.RData")
...
tm_train1 <- system.time(fit_train_depth_1 <- train(feat_train, label_train, list(depth=1)))
save(fit_train, file="../output/GBM_Baseline/fit_train.RData")
save(fit_train_depth_1, file="../output/GBM_Baseline/fit_train_depth_1.RData")
```
...
```{r superresolution}
source("../lib/GBM_Baseline/superResolution.R")
source("../lib/GBM_Baseline/test.R")
test_dir <- "../data/test_set/GBM_Baseline/" # This will be modified for different data sets.
test_LR_dir <- paste(test_dir, "LR/", sep="")
test_HR_dir <- paste(test_dir, "HR/", sep="")

tm_test=NA
if(run.test){
  load(file="../output/GBM_Baseline/fit_train.RData")
