...
if(run.cv){
  ...
  save(err_cv_xgboost, file="../output/XGB_3_3/err_cv_xgboost.RData")
}
```
...
```{r cv_vis}
if(run.cv){
  load("../output/XGB_3_3/err_cv_xgboost.RData")
...
save(fit_train_xgboost_3_3, file="../output/XGB_3_3/fit_train_xgboost_3_3.RData")
```
...
```{r superresolution}
source("../lib/XGB/superResolution_xgboost.R")
...
tm_test=NA
if(run.test){
  # load(file="../output/XGB_3_3/fit_train_xgboost_3_3.RData")
  tm_test <- system.time(superResolution_xgboost(test_LR_dir, test_HR_dir, fit_train_xgboost))
}
```
